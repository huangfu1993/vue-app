...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _uniNavBar = _interopRequireDefault(__webpack_require__(/*! @/components/uni-nav-bar/uni-nav-bar.vue */ 36));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { comments: { UniSearchBar: _uniNavBar.default }, data: function data() {return { textareavalue: '', imageList: [] };}, onLoad: function onLoad() {try {// uni.getStorage({\n      // \tkey: \"app-input\",\n      // \tsuccess: res => {\n      // \t\tconsole.log(res, 11111111111)\n      // \t},\n      // \tfail: err => console.log(err, '请求错误')\n      // })\n      var cache = uni.getStorageSync(\"app-input\");__f__(\"log\", cache, 'cache', \" at pages/addInput/addInput.vue:51\"); // if (cache) {\n      // \tconst obj = JSON.parse(cache);\n      // \tif (obj.textareavalue) {\n      // \t\tthis.textareavalue = obj.textareavalue\n      // \t}\n      // \tif (Array.isArray(obj.imageList)) {\n      // \t\tthis.imageList = obj.imageList\n      // \t}\n      // }\n    } catch (err) {__f__(\"log\", err, \" at pages/addInput/addInput.vue:64\");\n    }\n  },\n\n  methods: {\n    imageListChange: function imageListChange(list) {\n      this.imageList = list;\n    },\n    clickLeft: function clickLeft() {\n      uni.navigateBack();\n      // console.log(!!this.textareavalue, !!this.imageList.length)\n      // if (!!this.textareavalue || !!this.imageList.length) {\n      // \tuni.showModal({\n      // \t\t\ttitle: '提示',\n      // \t\t\tcontent: '是否保存为草稿？',\n      // \t\t\tsuccess: function (res) {\n      // \t\t\t\tif (res.confirm) {\n      // \t\t\t\t\tuni.setStorageSync(\"app-inpu\", JSON.stringify({ list: this.imageList, value: this.textareavalue }))\n      // \t\t\t\t\tsetTimeout(() => {\n      // \t\t\t\t\t\t// uni.navigateBack()\n      // \t\t\t\t\t\tconsole.log(uni.getStorageSync(\"app-input\"), 'uni.getStorageSync(\"app-input\")')\n      // \t\t\t\t\t}, 1000)\n      // \t\t\t\t\t\t// uni.setStorage({\n      // \t\t\t\t\t\t// \tkey: \"app-input\",\n      // \t\t\t\t\t\t// \tdata: JSON.stringify({ list: this.imageList, value: this.textareavalue }),\n      // \t\t\t\t\t\t// \tsuccess() {\n      // \t\t\t\t\t\t// \t\tconsole.log(uni.getStorageSync(\"app-input\"), 'uni.getStorageSync(\"app-input\")')\n      // \t\t\t\t\t\t// \t\t// uni.navigateBack()\n      // \t\t\t\t\t\t// \t}\n      // \t\t\t\t\t\t// })\n      // \t\t\t\t} else if (res.cancel) {\n      // \t\t\t\t\t\tuni.navigateBack()\n      // \t\t\t\t}\n      // \t\t\t}\n      // \t\t});\n      // \t} else {\n      // \t\tuni.navigateBack()\n      // \t}\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 54)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///53\n");
        ...
        _c("form", [
          _c(
            ...
            [
              _c(
                "view",
                { staticClass: _vm._$s(4, "sc", "cell-pd"), attrs: { _i: 4 } },
                [
                  _c(
                    "view",
                    {
                      staticClass: _vm._$s(5, "sc", "uni-uploader"),
                      attrs: { _i: 5 }
                    },
                    [
                      _c(
                        "view",
                        {
                          staticClass: _vm._$s(6, "sc", "uni-uploader-head"),
                          attrs: { _i: 6 }
                        },
                        [
                          _c("view", {
                            staticClass: _vm._$s(7, "sc", "uni-uploader-title"),
                            attrs: { _i: 7 }
                          }),
                          _c(
                            "view",
                            ...
                            [
                              _vm._v(
                                _vm._$s(8, "t0-0", _vm._s(_vm.imageList.length))
                              )
                            ]
                          )
                        ]
                      ...
                      _c(
                        "view",
                        {
                          staticClass: _vm._$s(9, "sc", "uni-uploader-body"),
                          attrs: { _i: 9 }
                        },
                        [
                          _c(
                            ...
                            [
                              _vm._l(
                                _vm._$s(11, "f", { forItems: _vm.imageList }),
