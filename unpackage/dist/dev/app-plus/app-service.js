...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _uniNavBar = _interopRequireDefault(__webpack_require__(/*! @/components/uni-nav-bar/uni-nav-bar.vue */ 36));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { comments: { UniSearchBar: _uniNavBar.default }, data: function data() {return { textareavalue: '', imageList: [] };}, onLoad: function onLoad() {var _this = this;try {uni.getStorage({ key: \"APPINOUT\", success: function success(res) {var thisObj = JSON.parse(res.data) || {};_this.textareavalue = thisObj.value;_this.imageList = thisObj.list;}, fail: function fail(err) {return console.err(err, '请求错误');} });} catch (err) {\n      throw err;\n    }\n  },\n  methods: {\n    imageListChange: function imageListChange(list) {\n      this.imageList = list;\n    },\n    clickLeft: function clickLeft() {var _this2 = this;\n      if (!!this.textareavalue || !!this.imageList.length) {\n        uni.showModal({\n          title: '提示',\n          content: '是否保存为草稿？',\n          success: function success(res) {\n            if (res.confirm) {\n              var obj = { list: _this2.imageList, value: _this2.textareavalue };\n              uni.setStorage({\n                key: \"APPINOUT\",\n                data: JSON.stringify(obj),\n                success: function success() {\n                  uni.navigateBack();\n                } });\n\n            } else if (res.cancel) {\n              uni.navigateBack();\n            }\n          } });\n\n      } else {\n        uni.navigateBack();\n      }\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///53\n");
